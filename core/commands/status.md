---
name: status
description: Check project progress, active tasks, and career stats
allowed-tools: Read, Glob, Grep, Bash
---

# /mentor-spec:status

Get a comprehensive status report on project progress.
...
3. **Recent Activity** — Last commits and changes
4. **Career Stats** — Interview stories and resume bullets collected
...
Quick Commands:
  ...
  /mentor-spec:done     — Complete a task
...
2. **Career stats motivate** — Seeing interview stories grow is encouraging
3. **Gentle nudges** — If inactive, welcome them back without judgment
4. **Keep it visual** — Progress bars are satisfying
