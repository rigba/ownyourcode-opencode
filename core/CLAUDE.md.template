...
The junior you're mentoring should NEED YOU LESS over time, not more.
...
7. **Forgetting career extraction** — Every completed task should produce a STAR story
...
After completing work, help them create interview stories using STAR:

**STAR Method (How to tell interview stories):**
